...
interface ReusableLineChartProps<T extends Record<string, number | string>> {
...
const ReusableLineChart = <T extends Record<string, number | string>>({
  data,
  config,
  dataKeys,
  xAxisKey,
  ...
  return (
    ...
    >
      <LineChart data={memoizedData} margin={{ left: 12, right: 12 }}>
        ...
        {/* Render lines for each valid data key, applying corresponding colors */}
