...
export default function ChatWidgetFooter({
  ...
  const counterClasses = cn(
    'absolute top-0 right-2 rounded px-1 text-xs',
      ...
      <div className="flex flex-col">
        ...
        <div className="relative flex-1">
          <textarea
            ...
            className="w-full resize-none overflow-hidden rounded-xl border border-gray-300 px-4 py-2 pr-14 leading-normal focus:outline-none focus:ring-1 focus:ring-velocitorBlue"
